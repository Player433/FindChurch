...
ActiveRecord::Schema.define(version: 20131007234759) do
  ...
  create_table "churches", force: :cascade do |t|
    ...
    t.string   "denomination", limit: 255, null: false
  ...
  add_index "details", ["church_id"], name: "index_details_on_church_id", using: :btree

  create_table "inbound_churches", force: :cascade do |t|
    t.string   "name",         limit: 255,   null: false
    t.text     "description",  limit: 65535
